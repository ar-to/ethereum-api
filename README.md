...
Configuring testnets and mainnet is more complicated than with local nodes. First create a new JSON file for the network you are adding to `network-wallets/ropsten.config.json`
